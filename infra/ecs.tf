# To put template in my services, I need to use the template_file data source. 
# The template_file data source allows you to render a template file with variables. 
# You can use the for_each meta-argument to create a template_file data source for each service in your ecs_services list. 
...
# Create an ECS task definition for each service in the ecs_services list.
...
# create cluster and service discovery namespace for ECS services
...
#create service discovery namespace for ECS services
