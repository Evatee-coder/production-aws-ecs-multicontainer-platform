...
resource "aws_db_instance" "postgres" {
  ...
  deletion_protection             = var.environment == "dev" ? false : true #just added for destroying dev db instance
  skip_final_snapshot             = var.environment == "dev" ? true : false #just added for destroying dev db instance
  #deletion_protection             = true #old
