# 1 vpc, 2 rds private subnets, 2 ecs private subnets, igw,
# nat gateway, route tables, security groups, and necessary outputs
...
# public subnets create resource, the count is 2, so it will create 2 subnets in different availability zones
...
# private subnets create resource, the count is 2, so it will create 2 subnets in different availability zones
